...
if(m=e[g]>d[g]?d[g]:e[g],a.css(g,m),a.css("position","relative"),a.css("top",i+"px"),a.css("left",j+"px"),b.runtimeStyle){var n=b.runtimeStyle;n.width=e.width*f[g]+"px",n.height=e.height*f[g]+"px"}}})},{jquery:1}],3:[function(a,b,c){(function(b){b.jQuery=a("jquery"),b.$=b.jQuery,a("./jquery.file-type-icon"),$view=$("#view"),$("#file").on("change",function(){var a=$(this).get(0).files,b=a[0];$view.fileTypeIcon({file:b,imageSize:{width:32,height:64}})})}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./jquery.file-type-icon":2,jquery:1}]},{},[2,3]);
//# sourceMappingURL=jquery.file-type-icon.sample.min.js.map