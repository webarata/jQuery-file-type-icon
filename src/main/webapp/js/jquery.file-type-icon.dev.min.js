...
if(m=e[g]>d[g]?d[g]:e[g],a.css(g,m),a.css("position","relative"),a.css("top",i+"px"),a.css("left",j+"px"),b.runtimeStyle){var n=b.runtimeStyle;n.width=e.width*f[g]+"px",n.height=e.height*f[g]+"px"}}})},{jquery:1}]},{},[3,2]);
//# sourceMappingURL=jquery.file-type-icon.dev.min.js.map